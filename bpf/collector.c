 ...
 *   - Waker stack on EV_BLOCK_END; subject stack_id = -1 until gopark/syscall probes
 *   - tid_to_task via casgstatus; sudog/futex aux fields reserved (see docs/ROADMAP.md)
